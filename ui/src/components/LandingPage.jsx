...
//               src={landingImage} 
//               alt="Logo" 
//               className="w-auto h-auto max-h-[40vh] object-contain mt-4" 
//             />
//           </div>
//         </div>
//       </main>
...
<div className="max-w-6xl w-full mx-auto flex flex-col md:flex-row items-center justify-between gap-40">
  ...
  <h1 className="text-5xl font-extrabold text-white mb-14 whitespace-nowrap font-display tracking-tight font-poppins">
       PERSONA PALOOZA! 🤖
    </h1>
